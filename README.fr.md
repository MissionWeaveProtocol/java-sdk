...
> Déclaration de conformité : **schema-and-vector conformance only**. Le SDK ne revendique pas une conformité complète du protocole à l’exécution.
...
| Commit du protocole | [`5821df8f0c07893f193af1908235888a0154fb6e`](https://github.com/missionweaveprotocol/missionweaveprotocol/commit/5821df8f0c07893f193af1908235888a0154fb6e) |
| JSON Schema | 21 |
...
- `SchemaCatalog` compile les 21 Schema Draft 2020-12 dans un registre entièrement hors ligne avec les assertions de format activées.
...
- Un résultat `43/43` démontre uniquement schema-and-vector conformance ; il n’établit ni interopérabilité, ni comportement complet, ni sécurité, ni aptitude à la production.
